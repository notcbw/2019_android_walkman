...
static const struct of_device_id imx_uart_dt_ids_with_console[] = {
	{ .compatible = "fsl,imx6q-uart", .data = &imx_uart_devdata[IMX6Q_UART], },
	{ .compatible = "fsl,imx53-uart", .data = &imx_uart_devdata[IMX53_UART], },
	{ .compatible = "fsl,imx1-uart", .data = &imx_uart_devdata[IMX1_UART], },
	{ .compatible = "fsl,imx21-uart", .data = &imx_uart_devdata[IMX21_UART], },
	{ .compatible = "fsl,imx8mm-console-uart", .data = &imx_uart_devdata[IMX6Q_UART], },
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, imx_uart_dt_ids_with_console);
...
static int __init imx_serial_init(void)
{
	...
	if (strstr(boot_command_line, "buildvariant=userdebug") ||
	    strstr(boot_command_line, "console=ttymxc"))
		serial_imx_driver.driver.of_match_table
			= imx_uart_dt_ids_with_console;

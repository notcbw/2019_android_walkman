...
static int model_index_ = 0;
static int channel_index_ = 0;

static A_STATUS ol_sdio_extra_initialization(struct ol_softc *scn);

#define BOARD_DATA_FILE_NAME "bdwlan30"
#define BOARD_DATA_FILE_EXT "bin"
                                 ...
                                 u32 target_version)
{
    ...
    scnprintf(pfw_files->board_data, sizeof(pfw_files->board_data),
              BOARD_DATA_FILE_NAME "_%02d%02d." BOARD_DATA_FILE_EXT,
              model_index_,
              channel_index_);
...
void ol_set_model_index(int model_index) {
  model_index_ = model_index;
}

void ol_set_channel_index(int channel_index) {

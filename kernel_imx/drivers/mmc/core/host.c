...
int mmc_of_parse(struct mmc_host *host)
{
	...
	/* f_max_limit is obtained from the optional "max-frequency-limit"
	 *  property.
	 */
	device_property_read_u32(dev,
		"max-frequency-limit", &host->f_max_limit
	);
...
struct mmc_host *mmc_alloc_host(int extra, struct device *dev)
{
	...
	host->f_max_limit = ~0U; /* Set harmless value. */
	host->use_blk_mq = mmc_use_blk_mq;
	host->card_drive_strength = MMC_HOST_CARD_DRIVE_STRENGTH_INVALID;

...
* Revision : 1.3.0 $
*
* Usage: Sensor Driver for BMA422 sensor
*
****************************************************************************
*
* Disclaimer
...
#define BMA422_FEATURE_SIZE			UINT8_C(38)
#define BMA422_ANYMOTION_EN_LEN			UINT8_C(2)
#define BMA422_RD_WR_MIN_LEN			UINT8_C(2)

/**\name Feature offset address */
#define BMA422_CONFIG_ID_OFFSET			UINT8_C(0x22)
#define BMA422_AXES_REMAP_OFFSET		UINT8_C(0x24)
#define BMA422_SIG_MOTION_OFFSET		UINT8_C(0x04)
#define BMA422_STEP_CNTR_OFFSET			UINT8_C(0x0A)
#define BMA422_STEP_CNTR_PARAM_OFFSET		UINT8_C(0x0C)
#define BMA422_TILT_OFFSET			UINT8_C(0x1A)
#define BMA422_PICKUP_OFFSET			UINT8_C(0x1C)
#define BMA422_GLANCE_OFFSET			UINT8_C(0x1E)
#define BMA422_WAKEUP_OFFSET			UINT8_C(0x20)
#define BMA422_ANY_NO_MOTION_OFFSET		UINT8_C(0x00)

/**************************************************************/
/**\name	Remap Axes */
/**************************************************************/
#define BMA422_X_AXIS_MASK			UINT8_C(0x03)
#define BMA422_X_AXIS_SIGN_MASK			UINT8_C(0x04)
#define BMA422_Y_AXIS_MASK			UINT8_C(0x18)
#define BMA422_Y_AXIS_SIGN_MASK			UINT8_C(0x20)
#define BMA422_Z_AXIS_MASK			UINT8_C(0xC0)
#define BMA422_Z_AXIS_SIGN_MASK			UINT8_C(0x01)

/**************************************************************/
/**\name	Significant motion */
/**************************************************************/
/**\name Significant motion enable macros */
#define BMA422_SIG_MOTION_EN_POS		UINT8_C(1)
#define BMA422_SIG_MOTION_EN_MSK		UINT8_C(0x02)

/**\name Significant motion threshold macros */
#define BMA422_SIG_MOTION_THRES_POS		UINT8_C(0)
#define BMA422_SIG_MOTION_THRES_MSK		UINT16_C(0x7FFF)

/**\name Significant motion skiptime macros */
#define BMA422_SIG_MOTION_SKIPTIME_POS		UINT8_C(0)
#define BMA422_SIG_MOTION_SKIPTIME_MSK		UINT16_C(0x01FF)

/**\name Significant motion prooftime macros */
#define BMA422_SIG_MOTION_PROOFTIME_POS		UINT8_C(0)
#define BMA422_SIG_MOTION_PROOFTIME_MSK		UINT8_C(0x7F)

/**************************************************************/
/**\name	Step Counter & Detector */
/**************************************************************/
/**\name Step detector enable macros */
#define BMA422_STEP_DETECTOR_EN_POS		UINT8_C(3)
#define BMA422_STEP_DETECTOR_EN_MSK		UINT8_C(0x08)

/**\name Step counter enable macros */
#define BMA422_STEP_CNTR_EN_POS			UINT8_C(4)
#define BMA422_STEP_CNTR_EN_MSK			UINT8_C(0x10)

/**\name Step counter watermark macros */
#define BMA422_STEP_CNTR_WM_POS			UINT8_C(0)
#define BMA422_STEP_CNTR_WM_MSK			UINT16_C(0x03FF)

/**\name Step counter reset macros */
#define BMA422_STEP_CNTR_RST_POS		UINT8_C(2)
#define BMA422_STEP_CNTR_RST_MSK		UINT8_C(0x04)

/**\name Total number of Step counter parameter settings */
#define BMA422_STEP_CNTR_PARAM_LEN		UINT8_C(7)

/**\name step count output length*/
#define BMA422_STEP_CNTR_DATA_SIZE		UINT16_C(4)
/**************************************************************/
/**\name	Tilt */
/**************************************************************/
/**\name Tilt enable macros */
#define BMA422_TILT_EN_POS		UINT8_C(4)
#define BMA422_TILT_EN_MSK		UINT8_C(0x10)

/**\name Tilt threshold macros */
#define BMA422_TILT_THRES_POS		UINT8_C(0)
#define BMA422_TILT_THRES_MSK		UINT8_C(0x0F)

/**************************************************************/
/**\name	Pick up */
/**************************************************************/
/**\name Pick up enable macros */
#define BMA422_PICKUP_EN_POS		UINT8_C(0)
#define BMA422_PICKUP_EN_MSK		UINT8_C(0x01)

/**************************************************************/
/**\name	Glance */
/**************************************************************/
/**\name Glance enable macros */
#define BMA422_GLANCE_EN_POS		UINT8_C(0)
#define BMA422_GLANCE_EN_MSK		UINT8_C(0x01)

/**************************************************************/
/**\name	Wake up */
/**************************************************************/
/**\name Wake up enable macros */
#define BMA422_WAKEUP_EN_POS		UINT8_C(0)
#define BMA422_WAKEUP_EN_MSK		UINT8_C(0x01)

/**\name Wake up sensitivity macros */
#define BMA422_WAKEUP_SENS_POS		UINT8_C(1)
#define BMA422_WAKEUP_SENS_MSK		UINT8_C(0x0E)

/**************************************************************/
/**\name	Any Motion */
/**************************************************************/
/**\name Any motion threshold macros */
#define BMA422_ANY_NO_MOTION_THRES_POS			UINT8_C(0)
#define BMA422_ANY_NO_MOTION_THRES_MSK			UINT16_C(0x07FF)

/**\name Any motion selection macros */
#define BMA422_ANY_NO_MOTION_SEL_POS			UINT8_C(3)
#define BMA422_ANY_NO_MOTION_SEL_MSK			UINT8_C(0x08)

/**\name Any motion enable macros */
#define BMA422_ANY_NO_MOTION_AXIS_EN_POS		UINT8_C(5)
#define BMA422_ANY_NO_MOTION_AXIS_EN_MSK		UINT8_C(0xE0)

/**\name Any motion duration macros */
#define BMA422_ANY_NO_MOTION_DUR_POS			UINT8_C(0)
#define BMA422_ANY_NO_MOTION_DUR_MSK			UINT16_C(0x1FFF)
...
#define BMA422_X_AXIS_EN				UINT8_C(0x01)
#define BMA422_Y_AXIS_EN				UINT8_C(0x02)
#define BMA422_Z_AXIS_EN				UINT8_C(0x04)
#define BMA422_EN_ALL_AXIS				UINT8_C(0x07)
#define BMA422_DIS_ALL_AXIS				UINT8_C(0x00)

/**\name Feature enable macros for the sensor */
#define BMA422_SIG_MOTION				UINT8_C(0x01)
#define BMA422_STEP_CNTR				UINT8_C(0x02)
#define BMA422_TILT					UINT8_C(0x04)
#define BMA422_PICKUP					UINT8_C(0x08)
#define BMA422_GLANCE					UINT8_C(0x10)
#define BMA422_WAKEUP					UINT8_C(0x20)
/**\name Below macros are mutually exclusive */
#define BMA422_ANY_MOTION				UINT8_C(0x40)
#define BMA422_NO_MOTION				UINT8_C(0x80)

/**\name Interrupt status macros */
#define	BMA422_SIG_MOTION_INT				UINT8_C(0x01)
#define BMA422_STEP_CNTR_INT				UINT8_C(0x02)
#define BMA422_TILT_INT					UINT8_C(0x04)
#define BMA422_PICKUP_INT				UINT8_C(0x08)
#define BMA422_GLANCE_INT				UINT8_C(0x10)
#define BMA422_WAKEUP_INT				UINT8_C(0x20)
#define BMA422_ANY_NO_MOTION_INT			UINT8_C(0x40)
#define BMA422_ERROR_INT				UINT8_C(0x80)


/*!
 * @brief Any motion configuration
 */
struct bma422_anymotion_config {
 ...
 */
struct bma422_sig_motion_config {
 ...
 */
struct bma422_stepcounter_settings {
 ...
 */
uint16_t bma422_init(struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_write_config_file(struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_get_config_id(uint16_t *config_id, struct bma4_dev *dev);
 ...
 *	Feature Interrupts
 *	  - BMA422_SIG_MOTION_INT
 *	  - BMA422_STEP_CNTR_INT
 *	  - BMA422_TILT_INT
 *	  - BMA422_PICKUP_INT
 *	  - BMA422_GLANCE_INT
 *	  - BMA422_WAKEUP_INT
 *	  - BMA422_ANY_NO_MOTION_INT
 *	  - BMA422_ERROR_INT
 *
 *	Hardware Interrupts
 *	  - BMA4_FIFO_FULL_INT
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_map_interrupt(uint8_t int_line, uint16_t int_map, uint8_t enable, struct bma4_dev *dev);

/*!
 *	@brief This API reads the bma422 interrupt status from the sensor.
 *
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_read_int_status(uint16_t *int_status, struct bma4_dev *dev);

/*!
 *	@brief @brief This API enables/disables the features of the sensor.
 *
 *	@param[in] feature : Variable to specify the features
 *	which are to be set in bma422 sensor.
 *	@param[in] enable : Variable which specifies whether to enable
 *	or disable.
 *	the features in the bma422 sensor
 *  enable		|	Macros
 *	------------|-------------------
 *   0x01		|  BMA4_EN
 *   0x00		|  BMA4_DIS
 ...
 *	- BMA422_GLANCE
 *	- BMA422_WAKEUP
 *	- BMA422_ANY_MOTION (or) BMA422_NO_MOTION
 *
 *	@return Result of API execution status
 *	@retval 0 -> Success
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_feature_enable(uint8_t feature, uint8_t enable, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_set_remap_axes(const struct bma422_axes_remap *remap_data, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_get_remap_axes(struct bma422_axes_remap *remap_data, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_set_sig_motion_config(const struct bma422_sig_motion_config *sig_motion, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_get_sig_motion_config(struct bma422_sig_motion_config *sig_motion, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_step_counter_set_watermark(uint16_t step_counter_wm, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_step_counter_get_watermark(uint16_t *step_counter_wm, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_reset_step_counter(struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_step_counter_output(uint32_t *step_count, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_stepcounter_get_parameter(struct bma422_stepcounter_settings *setting, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_stepcounter_set_parameter(const struct bma422_stepcounter_settings *setting, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_step_detector_enable(uint8_t enable, struct bma4_dev *dev);
 ...
 *	threshold,
 *	above which the tilt is signalled.
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_tilt_set_threshold(uint8_t threshold, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_tilt_get_threshold(uint8_t *threshold, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_wakeup_set_sensitivity(uint8_t sensitivity, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_wakeup_get_sensitivity(uint8_t *sensitivity, struct bma4_dev *dev);
 ...
 *  Value    |  Axis
 *  ---------|-------------------------
 *  0x00     |  BMA422_DIS_ALL_AXIS
 *  0x01     |  BMA422_X_AXIS_EN
 *  0x02     |  BMA422_Y_AXIS_EN
 *  0x04     |  BMA422_Z_AXIS_EN
 *  0x07     |  BMA422_EN_ALL_AXIS
 *	@param[in] dev : Structure instance of bma4_dev
 *
 *	@return result of API execution status
 *	@retval 0 -> Success
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_anymotion_enable_axis(uint8_t axis, struct bma4_dev *dev);
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_set_any_motion_config(const struct bma422_anymotion_config *any_motion, struct bma4_dev *dev);

/*!	@brief	This API gets the configuration of any motion feature from
 *	the sensor.
 *
 *	@param[out]	any_motion : Pointer to structure variable used to
 *	store the any motion feature settings read from the sensor.
 *	Structure members are provided in the table below
 *@verbatim
 * -------------------------------------------------------------------------
 *         Structure parameters    |        Description
 ...
 *	@retval Any non zero value -> Fail
 */
uint16_t bma422_get_any_motion_config(struct bma422_anymotion_config *any_motion, struct bma4_dev *dev);

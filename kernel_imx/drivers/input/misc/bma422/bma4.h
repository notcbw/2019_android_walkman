 ...
 *  @param[in] result_accel_data_diff : Pointer variable used to store the difference of accel values in mg
 *	operation
 *  result   |  Description
 *	---------|--------------------
 ...
 *
 */
uint16_t bma4_perform_accel_selftest(
	uint8_t *result,
	struct selftest_delta_limit *result_accel_data_diff,
	struct bma4_dev *dev);

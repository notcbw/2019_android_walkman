...
#define	MMC_HOST_DEBUG_PINCTRL_SIZE	(32)
...
#define MMC_HOST_CARD_DRIVE_STRENGTH_INVALID   (0xff)
	u8			card_drive_strength;    /* MMC Host prefered CARD drive strength. */
	ssize_t			debug_pinctrl_len;
	char			debug_pinctrl[MMC_HOST_DEBUG_PINCTRL_SIZE];
#define	MMC_HOST_DEBUG_PINCTRL_NORMAL	(0) /* normal operation. */
#define	MMC_HOST_DEBUG_PINCTRL_SKIP	(1) /* skip operation. */
#define	MMC_HOST_DEBUG_PINCTRL_ALL	(2) /* pinctrl selections. */
	int			debug_pinctrl_select;
